...
/**
 * This class defines the structure of the 'iptc' table.
 *
 *
 ...
 */
class IptcTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.IptcTableMap';
	...
	public function initialize()
	{
	  // attributes
		$this->setName('iptc');
		$this->setPhpName('Iptc');
		$this->setClassname('Iptc');
