...
class LogTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('LOG_TYPE', 'LogType', 'VARCHAR', true, 255, null);
		$this->addForeignKey('CUSTOMER_ID', 'CustomerId', 'INTEGER', 'customer', 'ID', true, null, null);
		$this->addColumn('CREATED_AT', 'CreatedAt', 'TIMESTAMP', true, null, null);
		$this->addColumn('IDS', 'Ids', 'LONGVARCHAR', true, null, null);
		// validators
	} // initialize()
    ...
    $this->addRelation('LogI18n', 'LogI18n', RelationMap::ONE_TO_MANY, array('id' => 'id', ), null, null);
	} // buildRelations()
	...
	public function getBehaviors()
	{
		return array(
			...
			'symfony_i18n' => array('i18n_table' => 'log_i18n', ),
		);
	} // getBehaviors()
