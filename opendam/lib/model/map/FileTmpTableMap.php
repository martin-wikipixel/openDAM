...
/**
 * This class defines the structure of the 'file_tmp' table.
 *
 *
 ...
 */
class FileTmpTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.FileTmpTableMap';
	...
	{
	  // attributes
		$this->setName('file_tmp');
		$this->setPhpName('FileTmp');
		$this->setClassname('FileTmp');
