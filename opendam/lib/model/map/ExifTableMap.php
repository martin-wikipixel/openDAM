...
/**
 * This class defines the structure of the 'exif' table.
 *
 *
 ...
 */
class ExifTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.ExifTableMap';
	...
	public function initialize()
	{
	  // attributes
		$this->setName('exif');
		$this->setPhpName('Exif');
		$this->setClassname('Exif');
