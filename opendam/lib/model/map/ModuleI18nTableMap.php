...
class ModuleI18nTableMap extends TableMap {
	 ...
	 */
	const CLASS_NAME = 'lib.model.map.ModuleI18nTableMap';
	...
	{
    $this->addRelation('Module', 'Module', RelationMap::MANY_TO_ONE, array('id' => 'id', ), null, null);
	} // buildRelations()
