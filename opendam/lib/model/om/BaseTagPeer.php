...
abstract class BaseTagPeer {
	...
	const CUSTOMER_ID = 'tag.CUSTOMER_ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Title', 'Description', 'CustomerId', 'CreatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'title', 'description', 'customerId', 'createdAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::TITLE, self::DESCRIPTION, self::CUSTOMER_ID, self::CREATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'title', 'description', 'customer_id', 'created_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Title' => 1, 'Description' => 2, 'CustomerId' => 3, 'CreatedAt' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'title' => 1, 'description' => 2, 'customerId' => 3, 'createdAt' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::TITLE => 1, self::DESCRIPTION => 2, self::CUSTOMER_ID => 3, self::CREATED_AT => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'title' => 1, 'description' => 2, 'customer_id' => 3, 'created_at' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(TagPeer::CUSTOMER_ID);
	...
	{
		// invalidate objects in FileTagPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	public static function doCountJoinCustomer(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(TagPeer::CUSTOMER_ID, CustomerPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Tag objects pre-filled with their Customer objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinCustomer(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Tag) to $obj2 (Customer)
				$obj2->addTag($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Tag) to the collection in $obj2 (Customer)
				$obj2->addTag($obj1);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related FileTag objects
			$criteria = new Criteria(FileTagPeer::DATABASE_NAME);
			
			$criteria->add(FileTagPeer::TAG_ID, $obj->getId());
			$affectedRows += FileTagPeer::doDelete($criteria, $con);
		}
		return $affectedRows;
	}
