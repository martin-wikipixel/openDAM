...
abstract class BaseModuleI18nPeer {
	...
	const OM_CLASS = 'ModuleI18n';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'lib.model.ModuleI18n';
	...
	const CULTURE = 'module_i18n.CULTURE';
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ModuleI18nPeer::CULTURE);
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseModuleI18nPeer', $criteria, $con);
		}
	 ...
	 *
	 * @param      ModuleI18n $value A ModuleI18n object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(ModuleI18n $obj, $key = null)
	{
	...
	public static function doSelectJoinModule(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		ModuleI18nPeer::addSelectColumns($criteria);
		$startcol = (ModuleI18nPeer::NUM_COLUMNS - ModuleI18nPeer::NUM_LAZY_LOAD_COLUMNS);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		ModuleI18nPeer::addSelectColumns($criteria);
		$startcol2 = (ModuleI18nPeer::NUM_COLUMNS - ModuleI18nPeer::NUM_LAZY_LOAD_COLUMNS);
	...
	{
		return $withPrefix ? ModuleI18nPeer::CLASS_DEFAULT : ModuleI18nPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a ModuleI18n or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseModuleI18nPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseModuleI18nPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseModuleI18nPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseModuleI18nPeer', $values, $con, $pk);
    }
	...
	/**
	 * Method perform an UPDATE on the database, given a ModuleI18n or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseModuleI18nPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseModuleI18nPeer', $values, $con))
      {
        return $sf_hook_retval;
		...
		if ($values instanceof Criteria) {
			...
			$selectCriteria->add(ModuleI18nPeer::ID, $criteria->remove(ModuleI18nPeer::ID), $comparison);

			$comparison = $criteria->getComparison(ModuleI18nPeer::CULTURE);
			$selectCriteria->add(ModuleI18nPeer::CULTURE, $criteria->remove(ModuleI18nPeer::CULTURE), $comparison);
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseModuleI18nPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseModuleI18nPeer', $values, $con, $ret);
    }
	...
	/**
	 * Method to DELETE all rows from the module_i18n table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += BasePeer::doDeleteAll(ModuleI18nPeer::TABLE_NAME, $con);
	...
	/**
	 * Method perform a DELETE on the database, given a ModuleI18n or Criteria object OR a primary key value.
	 *
	 ...
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			foreach ($values as $value) {
				...
				$criterion->addAnd($criteria->getNewCriterion(ModuleI18nPeer::CULTURE, $value[1]));
	 ...
	 */
	public static function doValidate(ModuleI18n $obj, $cols = null)
	{
		$columns = array();
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseModuleI18nPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
