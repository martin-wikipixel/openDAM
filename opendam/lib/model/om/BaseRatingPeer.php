...
abstract class BaseRatingPeer {
	...
	const FILE_ID = 'rating.FILE_ID';

	/** the column name for the NB_RATE field */
	const NB_RATE = 'rating.NB_RATE';

	/** the column name for the TOTAL_RATE field */
	const TOTAL_RATE = 'rating.TOTAL_RATE';

	/** the column name for the USER_IDS field */
	const USER_IDS = 'rating.USER_IDS';

	/** the column name for the CREATED_AT field */
	const CREATED_AT = 'rating.CREATED_AT';

	/** the column name for the UPDATED_AT field */
	const UPDATED_AT = 'rating.UPDATED_AT';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'FileId', 'NbRate', 'TotalRate', 'UserIds', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'fileId', 'nbRate', 'totalRate', 'userIds', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::FILE_ID, self::NB_RATE, self::TOTAL_RATE, self::USER_IDS, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'file_id', 'nb_rate', 'total_rate', 'user_ids', 'created_at', 'updated_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'FileId' => 1, 'NbRate' => 2, 'TotalRate' => 3, 'UserIds' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'fileId' => 1, 'nbRate' => 2, 'totalRate' => 3, 'userIds' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::FILE_ID => 1, self::NB_RATE => 2, self::TOTAL_RATE => 3, self::USER_IDS => 4, self::CREATED_AT => 5, self::UPDATED_AT => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'file_id' => 1, 'nb_rate' => 2, 'total_rate' => 3, 'user_ids' => 4, 'created_at' => 5, 'updated_at' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(RatingPeer::FILE_ID);
		$criteria->addSelectColumn(RatingPeer::NB_RATE);
		$criteria->addSelectColumn(RatingPeer::TOTAL_RATE);
		$criteria->addSelectColumn(RatingPeer::USER_IDS);
		$criteria->addSelectColumn(RatingPeer::CREATED_AT);
		$criteria->addSelectColumn(RatingPeer::UPDATED_AT);
	}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseRatingPeer', $criteria, $con);
		}
	...
	/**
	 * Method to invalidate the instance pool of all tables related to rating
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = RatingPeer::getOMClass(false);
	...
	public static function doCountJoinFile(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(RatingPeer::FILE_ID, FilePeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Rating objects pre-filled with their File objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinFile(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Rating) to $obj2 (File)
				$obj2->addRating($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Rating) to the collection in $obj2 (File)
				$obj2->addRating($obj1);
	...
	{
		return $withPrefix ? RatingPeer::CLASS_DEFAULT : RatingPeer::OM_CLASS;
	}
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseRatingPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseRatingPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseRatingPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseRatingPeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseRatingPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseRatingPeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseRatingPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseRatingPeer', $values, $con, $ret);
    }
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseRatingPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
