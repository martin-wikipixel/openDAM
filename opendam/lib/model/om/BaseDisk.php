...
/**
 * Base class that represents a row from the 'disk' table.
 *
 * 
 *
 ...
 */
abstract class BaseDisk extends BaseObject  implements Persistent {
	 ...
	 * @return     Disk The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = DiskPeer::ID;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = DiskPeer::NAME;
		}
	...
	public function setPath($v)
	{
		...
		if ($this->path !== $v) {
			$this->path = $v;
			$this->modifiedColumns[] = DiskPeer::PATH;
		}
	...
	public function setByDefault($v)
	{
		...
		if ($this->by_default !== $v) {
			$this->by_default = $v;
			$this->modifiedColumns[] = DiskPeer::BY_DEFAULT;
		}
	...
	public function setCustomerId($v)
	{
		...
		if ($this->customer_id !== $v) {
			$this->customer_id = $v;
			$this->modifiedColumns[] = DiskPeer::CUSTOMER_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->by_default = ($row[$startcol + 3] !== null) ? (boolean) $row[$startcol + 3] : null;
			...
			return $startcol + 5; // 5 = DiskPeer::NUM_COLUMNS - DiskPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating Disk object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = DiskPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseDisk:delete:pre') as $callable)
			{
			...
			if ($ret) {
				DiskPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseDisk:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseDisk:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseDisk:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				DiskPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					$affectedRows += DiskPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = DiskPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = DiskPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = DiskPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getName(),
			$keys[2] => $this->getPath(),
			$keys[3] => $this->getByDefault(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setByDefault($arr[$keys[3]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(DiskPeer::ID)) $criteria->add(DiskPeer::ID, $this->id);
		if ($this->isColumnModified(DiskPeer::NAME)) $criteria->add(DiskPeer::NAME, $this->name);
		if ($this->isColumnModified(DiskPeer::PATH)) $criteria->add(DiskPeer::PATH, $this->path);
		if ($this->isColumnModified(DiskPeer::BY_DEFAULT)) $criteria->add(DiskPeer::BY_DEFAULT, $this->by_default);
		if ($this->isColumnModified(DiskPeer::CUSTOMER_ID)) $criteria->add(DiskPeer::CUSTOMER_ID, $this->customer_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(DiskPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Disk (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setByDefault($this->by_default);
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Disk Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 * Otherwise if this Disk has previously been saved, it will retrieve
	 * related Files from storage. If this Disk is new, it will return
		...
		if ($this->collFiles === null) {
			if ($this->isNew()) {
			   $this->collFiles = array();
				...
				$criteria->add(FilePeer::DISK_ID, $this->id);
	 ...
	 * Otherwise if this Disk is new, it will return
	 * an empty collection; or if this Disk has previously
	 * been saved, it will retrieve related Files from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Disk.
	 */
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Disk has previously been saved, it will retrieve
	 * related Folders from storage. If this Disk is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collFolders === null) {
			if ($this->isNew()) {
			   $this->collFolders = array();
				...
				$criteria->add(FolderPeer::DISK_ID, $this->id);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Disk has previously been saved, it will retrieve
	 * related Groupes from storage. If this Disk is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collGroupes === null) {
			if ($this->isNew()) {
			   $this->collGroupes = array();
				...
				$criteria->add(GroupePeer::DISK_ID, $this->id);
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseDisk:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseDisk::%s', $method));
	  }
