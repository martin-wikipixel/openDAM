...
abstract class BaseUserGroup extends BaseObject  implements Persistent {
	...
	public function setGroupeId($v)
	{
		...
		if ($this->groupe_id !== $v) {
			$this->groupe_id = $v;
			$this->modifiedColumns[] = UserGroupPeer::GROUPE_ID;
		}
	...
	public function setRole($v)
	{
		...
		if ($this->role !== $v) {
			$this->role = $v;
			$this->modifiedColumns[] = UserGroupPeer::ROLE;
		}
	...
	public function setState($v)
	{
		...
		if ($this->state !== $v) {
			$this->state = $v;
			$this->modifiedColumns[] = UserGroupPeer::STATE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 5; // 5 = UserGroupPeer::NUM_COLUMNS - UserGroupPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(UserGroupPeer::GROUPE_ID)) $criteria->add(UserGroupPeer::GROUPE_ID, $this->groupe_id);
		if ($this->isColumnModified(UserGroupPeer::ROLE)) $criteria->add(UserGroupPeer::ROLE, $this->role);
		if ($this->isColumnModified(UserGroupPeer::STATE)) $criteria->add(UserGroupPeer::STATE, $this->state);
	...
	public function getGroupe(PropelPDO $con = null)
	{
		if ($this->aGroupe === null && ($this->groupe_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aGroupe->addUserGroups($this);
			 */
		}
		return $this->aGroupe;
	}
