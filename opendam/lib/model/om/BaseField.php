...
abstract class BaseField extends BaseObject  implements Persistent {
	...
	/**
	 * @var        array FieldContent[] Collection to store aggregation of FieldContent objects.
	 */
	protected $collFieldContents;

	/**
	 * @var        Criteria The criteria used to select the current contents of collFieldContents.
	 */
	private $lastFieldContentCriteria = null;
	...
	public function setGroupeId($v)
	{
		...
		if ($this->groupe_id !== $v) {
			$this->groupe_id = $v;
			$this->modifiedColumns[] = FieldPeer::GROUPE_ID;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = FieldPeer::NAME;
		}
	...
	public function setValues($v)
	{
		...
		if ($this->values !== $v) {
			$this->values = $v;
			$this->modifiedColumns[] = FieldPeer::VALUES;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->values = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		if ($deep) {  // also de-associate any related objects?
			...
			$this->aGroupe = null;
			$this->collFieldContents = null;
			$this->lastFieldContentCriteria = null;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->collFieldContents !== null) {
				foreach ($this->collFieldContents as $referrerFK) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(FieldPeer::GROUPE_ID)) $criteria->add(FieldPeer::GROUPE_ID, $this->groupe_id);
		if ($this->isColumnModified(FieldPeer::TYPE)) $criteria->add(FieldPeer::TYPE, $this->type);
		if ($this->isColumnModified(FieldPeer::NAME)) $criteria->add(FieldPeer::NAME, $this->name);
		if ($this->isColumnModified(FieldPeer::VALUES)) $criteria->add(FieldPeer::VALUES, $this->values);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		if ($deepCopy) {
			...
			foreach ($this->getFieldContents() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addFieldContent($relObj->copy($deepCopy));
				}
			}
	...
	/**
	 * Clears out the collFieldContents collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 * @return     void
	 * @see        addFieldContents()
	 */
	public function clearFieldContents()
	{
		$this->collFieldContents = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collFieldContents collection (array).
	 *
	 * By default this just sets the collFieldContents collection to an empty array (like clearcollFieldContents());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initFieldContents()
	{
		$this->collFieldContents = array();
	}

	/**
	 * Gets an array of FieldContent objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Field has previously been saved, it will retrieve
	 * related FieldContents from storage. If this Field is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 * @return     array FieldContent[]
	 * @throws     PropelException
	 */
	public function getFieldContents($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(FieldPeer::DATABASE_NAME);
		}
		...
		if ($this->collFieldContents === null) {
			if ($this->isNew()) {
			   $this->collFieldContents = array();
				...
				$criteria->add(FieldContentPeer::FIELD_ID, $this->id);

				FieldContentPeer::addSelectColumns($criteria);
				$this->collFieldContents = FieldContentPeer::doSelect($criteria, $con);
			}
		} else {
			...
			if (!$this->isNew()) {
				...
				FieldContentPeer::addSelectColumns($criteria);
				if (!isset($this->lastFieldContentCriteria) || !$this->lastFieldContentCriteria->equals($criteria)) {
					$this->collFieldContents = FieldContentPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastFieldContentCriteria = $criteria;
		return $this->collFieldContents;
	}

	/**
	 * Returns the number of related FieldContent objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related FieldContent objects.
	 * @throws     PropelException
	 */
	public function countFieldContents(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(FieldPeer::DATABASE_NAME);
		} else {
		...
		if ($this->collFieldContents === null) {
			if ($this->isNew()) {
				...
				$count = FieldContentPeer::doCount($criteria, false, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				if (!isset($this->lastFieldContentCriteria) || !$this->lastFieldContentCriteria->equals($criteria)) {
					...
					$count = count($this->collFieldContents);
				}
			} else {
				$count = count($this->collFieldContents);
			}
	...
	/**
	 * Method called to associate a FieldContent object to this object
	 * through the FieldContent foreign key attribute.
	 *
	 * @param      FieldContent $l FieldContent
	 * @return     void
	 * @throws     PropelException
	 */
	public function addFieldContent(FieldContent $l)
	{
		if ($this->collFieldContents === null) {
			$this->initFieldContents();
		}
		if (!in_array($l, $this->collFieldContents, true)) { // only add it if the **same** object is not already associated
			array_push($this->collFieldContents, $l);
			$l->setField($this);
		}
	}
	...
	{
		if ($deep) {
			if ($this->collFieldContents) {
				foreach ((array) $this->collFieldContents as $o) {
