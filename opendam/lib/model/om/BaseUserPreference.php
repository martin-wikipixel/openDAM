...
/**
 * Base class that represents a row from the 'user_preference' table.
 *
 * 
 *
...
abstract class BaseUserPreference extends BaseObject  implements Persistent {
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = UserPreferencePeer::ID;
		}
	...
	public function setTitle($v)
	{
		...
		if ($this->title !== $v) {
			$this->title = $v;
			$this->modifiedColumns[] = UserPreferencePeer::TITLE;
		}
	...
	public function setValue($v)
	{
		...
		if ($this->value !== $v) {
			$this->value = $v;
			$this->modifiedColumns[] = UserPreferencePeer::VALUE;
		}
	...
	public function setOrder($v)
	{
		...
		if ($this->order !== $v) {
			$this->order = $v;
			$this->modifiedColumns[] = UserPreferencePeer::ORDER;
		}
	...
	public function setUserId($v)
	{
		...
		if ($this->user_id !== $v) {
			$this->user_id = $v;
			$this->modifiedColumns[] = UserPreferencePeer::USER_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 5; // 5 = UserPreferencePeer::NUM_COLUMNS - UserPreferencePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(UserPreferencePeer::ID)) $criteria->add(UserPreferencePeer::ID, $this->id);
		if ($this->isColumnModified(UserPreferencePeer::TITLE)) $criteria->add(UserPreferencePeer::TITLE, $this->title);
		if ($this->isColumnModified(UserPreferencePeer::VALUE)) $criteria->add(UserPreferencePeer::VALUE, $this->value);
		if ($this->isColumnModified(UserPreferencePeer::ORDER)) $criteria->add(UserPreferencePeer::ORDER, $this->order);
		if ($this->isColumnModified(UserPreferencePeer::USER_ID)) $criteria->add(UserPreferencePeer::USER_ID, $this->user_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(UserPreferencePeer::ID, $this->id);
	...
	public function getUser(PropelPDO $con = null)
	{
		if ($this->aUser === null && ($this->user_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aUser->addUserPreferences($this);
			 */
		}
		return $this->aUser;
	}
