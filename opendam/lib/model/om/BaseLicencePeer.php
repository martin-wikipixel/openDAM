...
abstract class BaseLicencePeer {
	...
	const OM_CLASS = 'Licence';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'lib.model.Licence';
	...
	const CREATED_AT = 'licence.CREATED_AT';
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(LicencePeer::CREATED_AT);
	}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseLicencePeer', $criteria, $con);
		}
	 ...
	 *
	 * @param      Licence $value A Licence object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(Licence $obj, $key = null)
	{
	...
	{
		return $withPrefix ? LicencePeer::CLASS_DEFAULT : LicencePeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a Licence or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseLicencePeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseLicencePeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseLicencePeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseLicencePeer', $values, $con, $pk);
    }
	...
	/**
	 * Method perform an UPDATE on the database, given a Licence or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseLicencePeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseLicencePeer', $values, $con))
      {
        return $sf_hook_retval;
		...
		if ($values instanceof Criteria) {
			...
			$selectCriteria->add(LicencePeer::ID, $criteria->remove(LicencePeer::ID), $comparison);
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseLicencePeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseLicencePeer', $values, $con, $ret);
    }
	...
	/**
	 * Method to DELETE all rows from the licence table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += LicencePeer::doOnDeleteCascade(new Criteria(LicencePeer::DATABASE_NAME), $con);
			$affectedRows += BasePeer::doDeleteAll(LicencePeer::TABLE_NAME, $con);
	...
	/**
	 * Method perform a DELETE on the database, given a Licence or Criteria object OR a primary key value.
	 *
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			$affectedRows += LicencePeer::doOnDeleteCascade($criteria, $con);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		$objects = LicencePeer::doSelect($criteria, $con);
	 ...
	 */
	public static function doValidate(Licence $obj, $cols = null)
	{
		$columns = array();
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseLicencePeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
	...
	/**
	 * Selects a collection of {@link Licence} objects with a {@link LicenceI18n} translation populated.
	 *
	 * @param Criteria  $criteria
	...
	static public function doSelectWithI18n(Criteria $criteria, $culture = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
	  ...
	  LicencePeer::addSelectColumns($criteria);
	  $startcol = (LicencePeer::NUM_COLUMNS - LicencePeer::NUM_LAZY_LOAD_COLUMNS);
	  LicenceI18nPeer::addSelectColumns($criteria);
	  $criteria->addJoin(LicencePeer::ID, LicenceI18nPeer::ID, $join_behavior);
	  $criteria->add(LicenceI18nPeer::CULTURE, $culture);
	
	  foreach (sfMixer::getCallables('BaseLicence:doSelectJoin:doSelectJoin') as $sf_hook)
	  {
	    call_user_func($sf_hook, 'Licence', $criteria, $con);
	  }
	  ...
	  $stmt = BasePeer::doSelect($criteria, $con);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key1 = LicencePeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj1 = LicencePeer::getInstanceFromPool($key1))) {
				// We no longer rehydrate the object, since this can cause data loss.
	  		// See http://propel.phpdb.org/trac/ticket/509
	  		// $obj1->hydrate($row, 0, true); // rehydrate
				...
				$obj1 = new $cls();
				$obj1->hydrate($row);
	      LicencePeer::addInstanceToPool($obj1, $key1);
			} // if $obj1 already loaded
	
			$key2 = LicenceI18nPeer::getPrimaryKeyHashFromRow($row, $startcol);
			if ($key2 !== null) {
				$obj2 = LicenceI18nPeer::getInstanceFromPool($key2);
				if (!$obj2) {
					$cls = LicenceI18nPeer::getOMClass(false);
					$obj2 = new $cls();
					$obj2->hydrate($row, $startcol);
					LicenceI18nPeer::addInstanceToPool($obj2, $key2);
				} // if obj2 already loaded
	
	      $obj1->setLicenceI18nForCulture($obj2, $culture);
