...
abstract class BaseRolePeer {
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseRolePeer', $criteria, $con);
		}
	...
	public static function clearRelatedInstancePool()
	{
		...
		// invalidate objects in ConstraintPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseRolePeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseRolePeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseRolePeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseRolePeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseRolePeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseRolePeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseRolePeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseRolePeer', $values, $con, $ret);
    }
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			RolePeer::doOnDeleteSetNull(new Criteria(RolePeer::DATABASE_NAME), $con);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			RolePeer::doOnDeleteSetNull($criteria, $con);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$criteria->add(UnitGroupPeer::ROLE, $obj->getId());
			$affectedRows += UnitGroupPeer::doDelete($criteria, $con);

			// delete related Constraint objects
			$criteria = new Criteria(ConstraintPeer::DATABASE_NAME);
			
			$criteria->add(ConstraintPeer::ROLE_ID, $obj->getId());
			$affectedRows += ConstraintPeer::doDelete($criteria, $con);
		}
		return $affectedRows;
	}
	...
	protected static function doOnDeleteSetNull(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$updateValues = new Criteria(RolePeer::DATABASE_NAME);
			$selectCriteria->add(GroupePeer::FREE_CREDENTIAL, $obj->getId());
			$updateValues->add(GroupePeer::FREE_CREDENTIAL, null);
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseRolePeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
