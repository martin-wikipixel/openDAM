...
abstract class BaseCountryPeer {
	...
	const PHONE_CODE = 'country.PHONE_CODE';

	/** the column name for the UE field */
	const UE = 'country.UE';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'ContinentId', 'PhoneCode', 'Ue', 'CreatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'continentId', 'phoneCode', 'ue', 'createdAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::CONTINENT_ID, self::PHONE_CODE, self::UE, self::CREATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'continent_id', 'phone_code', 'ue', 'created_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'ContinentId' => 1, 'PhoneCode' => 2, 'Ue' => 3, 'CreatedAt' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'continentId' => 1, 'phoneCode' => 2, 'ue' => 3, 'createdAt' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::CONTINENT_ID => 1, self::PHONE_CODE => 2, self::UE => 3, self::CREATED_AT => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'continent_id' => 1, 'phone_code' => 2, 'ue' => 3, 'created_at' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CountryPeer::CONTINENT_ID);
		$criteria->addSelectColumn(CountryPeer::PHONE_CODE);
		$criteria->addSelectColumn(CountryPeer::UE);
	...
	public static function doCountJoinContinent(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(CountryPeer::CONTINENT_ID, ContinentPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Country objects pre-filled with their Continent objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinContinent(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Country) to $obj2 (Continent)
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		CountryPeer::addSelectColumns($criteria);
		$startcol2 = (CountryPeer::NUM_COLUMNS - CountryPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Country) to the collection in $obj2 (Continent)
				$obj2->addCountry($obj1);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$criteria->add(CustomerPeer::COUNTRY_ID, $obj->getId());
			$affectedRows += CustomerPeer::doDelete($criteria, $con);

			// delete related User objects
			$criteria = new Criteria(UserPeer::DATABASE_NAME);
			
			$criteria->add(UserPeer::COUNTRY_ID, $obj->getId());
	...
	/**
	 * Selects a collection of {@link Country} objects with a {@link CountryI18n} translation populated.
	 *
	 * @param Criteria  $criteria
	...
	static public function doSelectWithI18n(Criteria $criteria, $culture = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
	  ...
	  $criteria->addJoin(CountryPeer::ID, CountryI18nPeer::ID, $join_behavior);
	  $criteria->add(CountryI18nPeer::CULTURE, $culture);
	
	  foreach (sfMixer::getCallables('BaseCountry:doSelectJoin:doSelectJoin') as $sf_hook)
	  {
	    call_user_func($sf_hook, 'Country', $criteria, $con);
	  }
	  ...
	  $stmt = BasePeer::doSelect($criteria, $con);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
	      ...
	      CountryPeer::addInstanceToPool($obj1, $key1);
			...
			$key2 = CountryI18nPeer::getPrimaryKeyHashFromRow($row, $startcol);
			if ($key2 !== null) {
				$obj2 = CountryI18nPeer::getInstanceFromPool($key2);
				if (!$obj2) {
					$cls = CountryI18nPeer::getOMClass(false);
					$obj2 = new $cls();
					$obj2->hydrate($row, $startcol);
					CountryI18nPeer::addInstanceToPool($obj2, $key2);
				} // if obj2 already loaded
