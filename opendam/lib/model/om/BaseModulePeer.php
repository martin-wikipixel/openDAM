...
abstract class BaseModulePeer {
	...
	const CLASS_DEFAULT = 'lib.model.Module';
	...
	const DEACTIVATED = 'module.DEACTIVATED';

	/** the column name for the DEFAULT_VALUE field */
	const DEFAULT_VALUE = 'module.DEFAULT_VALUE';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Deactivated', 'DefaultValue', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'deactivated', 'defaultValue', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::DEACTIVATED, self::DEFAULT_VALUE, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'deactivated', 'default_value', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Deactivated' => 1, 'DefaultValue' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'deactivated' => 1, 'defaultValue' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::DEACTIVATED => 1, self::DEFAULT_VALUE => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'deactivated' => 1, 'default_value' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ModulePeer::DEACTIVATED);
		$criteria->addSelectColumn(ModulePeer::DEFAULT_VALUE);
	}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseModulePeer', $criteria, $con);
		}
	...
	{
		// invalidate objects in ModuleValuePeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	public static function doCountJoinModuleValue(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(ModulePeer::DEFAULT_VALUE, ModuleValuePeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Module objects pre-filled with their ModuleValue objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinModuleValue(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Module) to $obj2 (ModuleValue)
				$obj2->addModule($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Module) to the collection in $obj2 (ModuleValue)
				$obj2->addModule($obj1);
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseModulePeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseModulePeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseModulePeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseModulePeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseModulePeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseModulePeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseModulePeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseModulePeer', $values, $con, $ret);
    }
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related ModuleValue objects
			$criteria = new Criteria(ModuleValuePeer::DATABASE_NAME);
			
			$criteria->add(ModuleValuePeer::MODULE_ID, $obj->getId());
			$affectedRows += ModuleValuePeer::doDelete($criteria, $con);

			// delete related CustomerHasModule objects
			$criteria = new Criteria(CustomerHasModulePeer::DATABASE_NAME);
			
			$criteria->add(CustomerHasModulePeer::MODULE_ID, $obj->getId());
			...
			$criteria->add(UserHasModulePeer::MODULE_ID, $obj->getId());
			...
			$criteria->add(ModuleHasVisibilityPeer::MODULE_ID, $obj->getId());
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseModulePeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
	...
	/**
	 * Selects a collection of {@link Module} objects with a {@link ModuleI18n} translation populated.
	 *
	 * @param Criteria  $criteria
	...
	static public function doSelectWithI18n(Criteria $criteria, $culture = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
	  ...
	  $criteria->addJoin(ModulePeer::ID, ModuleI18nPeer::ID, $join_behavior);
	  $criteria->add(ModuleI18nPeer::CULTURE, $culture);
	
	  foreach (sfMixer::getCallables('BaseModule:doSelectJoin:doSelectJoin') as $sf_hook)
	  {
	    call_user_func($sf_hook, 'Module', $criteria, $con);
	  }
	  ...
	  $stmt = BasePeer::doSelect($criteria, $con);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
	      ...
	      ModulePeer::addInstanceToPool($obj1, $key1);
			...
			$key2 = ModuleI18nPeer::getPrimaryKeyHashFromRow($row, $startcol);
			if ($key2 !== null) {
				$obj2 = ModuleI18nPeer::getInstanceFromPool($key2);
				if (!$obj2) {
					$cls = ModuleI18nPeer::getOMClass(false);
					$obj2 = new $cls();
					$obj2->hydrate($row, $startcol);
					ModuleI18nPeer::addInstanceToPool($obj2, $key2);
				} // if obj2 already loaded
	
	      $obj1->setModuleI18nForCulture($obj2, $culture);
			} // if joined row was not null
