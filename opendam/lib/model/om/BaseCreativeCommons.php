...
/**
 * Base class that represents a row from the 'creative_commons' table.
 *
 * 
 *
 ...
 */
abstract class BaseCreativeCommons extends BaseObject  implements Persistent {
	...
	/**
	 * @var        array CreativeCommonsI18n[] Collection to store aggregation of CreativeCommonsI18n objects.
	 */
	protected $collCreativeCommonsI18ns;

	/**
	 * @var        Criteria The criteria used to select the current contents of collCreativeCommonsI18ns.
	 */
	private $lastCreativeCommonsI18nCriteria = null;
	...
	const PEER = 'CreativeCommonsPeer';
	 ...
	 * @return     CreativeCommons The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = CreativeCommonsPeer::ID;
		}
	...
	public function setImagePath($v)
	{
		...
		if ($this->image_path !== $v) {
			$this->image_path = $v;
			$this->modifiedColumns[] = CreativeCommonsPeer::IMAGE_PATH;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = CreativeCommonsPeer::CREATED_AT;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = CreativeCommonsPeer::NUM_COLUMNS - CreativeCommonsPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating CreativeCommons object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = CreativeCommonsPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
		...
		if ($deep) {  // also de-associate any related objects?
			...
			$this->collCreativeCommonsI18ns = null;
			$this->lastCreativeCommonsI18nCriteria = null;
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseCreativeCommons:delete:pre') as $callable)
			{
			...
			if ($ret) {
				CreativeCommonsPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseCreativeCommons:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseCreativeCommons:save:pre') as $callable)
			{
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(CreativeCommonsPeer::CREATED_AT))
				{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseCreativeCommons:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				CreativeCommonsPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = CreativeCommonsPeer::doInsert($this, $con);
					...
					$affectedRows += CreativeCommonsPeer::doUpdate($this, $con);
				}
			...
			if ($this->collCreativeCommonsI18ns !== null) {
				foreach ($this->collCreativeCommonsI18ns as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = CreativeCommonsPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = CreativeCommonsPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = CreativeCommonsPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CreativeCommonsPeer::ID)) $criteria->add(CreativeCommonsPeer::ID, $this->id);
		if ($this->isColumnModified(CreativeCommonsPeer::IMAGE_PATH)) $criteria->add(CreativeCommonsPeer::IMAGE_PATH, $this->image_path);
		if ($this->isColumnModified(CreativeCommonsPeer::CREATED_AT)) $criteria->add(CreativeCommonsPeer::CREATED_AT, $this->created_at);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(CreativeCommonsPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of CreativeCommons (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		if ($deepCopy) {
			...
			foreach ($this->getCreativeCommonsI18ns() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addCreativeCommonsI18n($relObj->copy($deepCopy));
				}
			}
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     CreativeCommons Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     CreativeCommonsPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new CreativeCommonsPeer();
		}
		return self::$peer;
	}
	 ...
	 * Otherwise if this CreativeCommons has previously been saved, it will retrieve
	 * related Files from storage. If this CreativeCommons is new, it will return
		...
		if ($this->collFiles === null) {
			if ($this->isNew()) {
			   $this->collFiles = array();
				...
				$criteria->add(FilePeer::CREATIVE_COMMONS_ID, $this->id);
	 ...
	 * Otherwise if this CreativeCommons is new, it will return
	 * an empty collection; or if this CreativeCommons has previously
	 * been saved, it will retrieve related Files from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in CreativeCommons.
	 */
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this CreativeCommons has previously been saved, it will retrieve
	 * related Folders from storage. If this CreativeCommons is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collFolders === null) {
			if ($this->isNew()) {
			   $this->collFolders = array();
				...
				$criteria->add(FolderPeer::CREATIVE_COMMONS_ID, $this->id);
	...
	/**
	 * Clears out the collCreativeCommonsI18ns collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 * @return     void
	 * @see        addCreativeCommonsI18ns()
	 */
	public function clearCreativeCommonsI18ns()
	{
		$this->collCreativeCommonsI18ns = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collCreativeCommonsI18ns collection (array).
	 *
	 * By default this just sets the collCreativeCommonsI18ns collection to an empty array (like clearcollCreativeCommonsI18ns());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initCreativeCommonsI18ns()
	{
		$this->collCreativeCommonsI18ns = array();
	}

	/**
	 * Gets an array of CreativeCommonsI18n objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this CreativeCommons has previously been saved, it will retrieve
	 * related CreativeCommonsI18ns from storage. If this CreativeCommons is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 * @return     array CreativeCommonsI18n[]
	 * @throws     PropelException
	 */
	public function getCreativeCommonsI18ns($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(CreativeCommonsPeer::DATABASE_NAME);
		}
		...
		if ($this->collCreativeCommonsI18ns === null) {
			if ($this->isNew()) {
			   $this->collCreativeCommonsI18ns = array();
				...
				$criteria->add(CreativeCommonsI18nPeer::ID, $this->id);

				CreativeCommonsI18nPeer::addSelectColumns($criteria);
				$this->collCreativeCommonsI18ns = CreativeCommonsI18nPeer::doSelect($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				CreativeCommonsI18nPeer::addSelectColumns($criteria);
				if (!isset($this->lastCreativeCommonsI18nCriteria) || !$this->lastCreativeCommonsI18nCriteria->equals($criteria)) {
					$this->collCreativeCommonsI18ns = CreativeCommonsI18nPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastCreativeCommonsI18nCriteria = $criteria;
		return $this->collCreativeCommonsI18ns;
	}

	/**
	 * Returns the number of related CreativeCommonsI18n objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related CreativeCommonsI18n objects.
	 * @throws     PropelException
	 */
	public function countCreativeCommonsI18ns(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(CreativeCommonsPeer::DATABASE_NAME);
		} else {
		...
		if ($this->collCreativeCommonsI18ns === null) {
			if ($this->isNew()) {
				...
				$count = CreativeCommonsI18nPeer::doCount($criteria, false, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				if (!isset($this->lastCreativeCommonsI18nCriteria) || !$this->lastCreativeCommonsI18nCriteria->equals($criteria)) {
					...
					$count = count($this->collCreativeCommonsI18ns);
				}
			} else {
				$count = count($this->collCreativeCommonsI18ns);
			}
	...
	/**
	 * Method called to associate a CreativeCommonsI18n object to this object
	 * through the CreativeCommonsI18n foreign key attribute.
	 *
	 * @param      CreativeCommonsI18n $l CreativeCommonsI18n
	 * @return     void
	 * @throws     PropelException
	 */
	public function addCreativeCommonsI18n(CreativeCommonsI18n $l)
	{
		if ($this->collCreativeCommonsI18ns === null) {
			$this->initCreativeCommonsI18ns();
		}
		if (!in_array($l, $this->collCreativeCommonsI18ns, true)) { // only add it if the **same** object is not already associated
			array_push($this->collCreativeCommonsI18ns, $l);
			$l->setCreativeCommons($this);
		}
	}
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this CreativeCommons has previously been saved, it will retrieve
	 * related Presets from storage. If this CreativeCommons is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collPresets === null) {
			if ($this->isNew()) {
			   $this->collPresets = array();
				...
				$criteria->add(PresetPeer::CREATIVE_COMMONS_ID, $this->id);
	...
	public function clearAllReferences($deep = false)
	{
		if ($deep) {
			...
			if ($this->collCreativeCommonsI18ns) {
				foreach ((array) $this->collCreativeCommonsI18ns as $o) {
					$o->clearAllReferences($deep);
				}
			}
			if ($this->collPresets) {
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseCreativeCommons:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseCreativeCommons::%s', $method));
	  }
	...
	/**
	 * Returns the "title" value from the current {@link CreativeCommonsI18n}.
	 */
	public function getTitle($culture = null)
	{
	  return $this->getCurrentCreativeCommonsI18n($culture)->getTitle();
	}
	
	/**
	 * Sets the "title" value of the current {@link CreativeCommonsI18n}.
	 *
	 * @return CreativeCommons
	 */
	public function setTitle($value, $culture = null)
	{
	  $this->getCurrentCreativeCommonsI18n($culture)->setTitle($value);
	  return $this;
	}
	
	/**
	 * Returns the "description" value from the current {@link CreativeCommonsI18n}.
	 */
	public function getDescription($culture = null)
	{
	  return $this->getCurrentCreativeCommonsI18n($culture)->getDescription();
	}
	
	/**
	 * Sets the "description" value of the current {@link CreativeCommonsI18n}.
	 *
	 * @return CreativeCommons
	 */
	public function setDescription($value, $culture = null)
	{
	  $this->getCurrentCreativeCommonsI18n($culture)->setDescription($value);
	  return $this;
	}
	 ...
	 */
	public function getCurrentCreativeCommonsI18n($culture = null)
	{
	  if (null === $culture)
	  {
	  ...
	  {
	    $object = $this->isNew() ? null : CreativeCommonsI18nPeer::retrieveByPK($this->getPrimaryKey(), $culture);
	    if ($object)
	    {
	      $this->setCreativeCommonsI18nForCulture($object, $culture);
	    }
	    else
	    {
	      $this->setCreativeCommonsI18nForCulture(new CreativeCommonsI18n(), $culture);
	 ...
	 */
	public function setCreativeCommonsI18nForCulture(CreativeCommonsI18n $object, $culture)
	{
	  $this->current_i18n[$culture] = $object;
	  $this->addCreativeCommonsI18n($object);
	}
