...
abstract class BaseLogPeer {
	...
	const LOG_TYPE = 'log.LOG_TYPE';

	/** the column name for the CUSTOMER_ID field */
	const CUSTOMER_ID = 'log.CUSTOMER_ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'Type', 'ObjectId', 'LogType', 'CustomerId', 'CreatedAt', 'Ids', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'type', 'objectId', 'logType', 'customerId', 'createdAt', 'ids', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USER_ID, self::TYPE, self::OBJECT_ID, self::LOG_TYPE, self::CUSTOMER_ID, self::CREATED_AT, self::IDS, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'type', 'object_id', 'log_type', 'customer_id', 'created_at', 'ids', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'Type' => 2, 'ObjectId' => 3, 'LogType' => 4, 'CustomerId' => 5, 'CreatedAt' => 6, 'Ids' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'type' => 2, 'objectId' => 3, 'logType' => 4, 'customerId' => 5, 'createdAt' => 6, 'ids' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_ID => 1, self::TYPE => 2, self::OBJECT_ID => 3, self::LOG_TYPE => 4, self::CUSTOMER_ID => 5, self::CREATED_AT => 6, self::IDS => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'type' => 2, 'object_id' => 3, 'log_type' => 4, 'customer_id' => 5, 'created_at' => 6, 'ids' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(LogPeer::LOG_TYPE);
		$criteria->addSelectColumn(LogPeer::CUSTOMER_ID);
		$criteria->addSelectColumn(LogPeer::CREATED_AT);
		$criteria->addSelectColumn(LogPeer::IDS);
	}
	...
	public static function doCountJoinUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(LogPeer::USER_ID, UserPeer::ID, $join_behavior);
	...
	public static function doCountJoinCustomer(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(LogPeer::CUSTOMER_ID, CustomerPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Log objects pre-filled with their User objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	/**
	 * Selects a collection of Log objects pre-filled with their Customer objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Log objects.
	...
	public static function doSelectJoinCustomer(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Log) to $obj2 (Customer)
				$obj2->addLog($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Log) to the collection in $obj2 (User)
				$obj2->addLog($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (Log) to the collection in $obj3 (Customer)
				$obj3->addLog($obj1);
			} // if joined row not null
	...
	public static function doSelectJoinAllExceptUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = LogPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (Log) to the collection in $obj2 (Customer)
				$obj2->addLog($obj1);
	...
	/**
	 * Selects a collection of Log objects pre-filled with all related objects except Customer.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	/**
	 * Selects a collection of {@link Log} objects with a {@link LogI18n} translation populated.
	 *
	 * @param Criteria  $criteria
	...
	static public function doSelectWithI18n(Criteria $criteria, $culture = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
	  ...
	  $criteria->addJoin(LogPeer::ID, LogI18nPeer::ID, $join_behavior);
	  $criteria->add(LogI18nPeer::CULTURE, $culture);
	
	  foreach (sfMixer::getCallables('BaseLog:doSelectJoin:doSelectJoin') as $sf_hook)
	  {
	    call_user_func($sf_hook, 'Log', $criteria, $con);
	  }
	  ...
	  $stmt = BasePeer::doSelect($criteria, $con);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
	      ...
	      LogPeer::addInstanceToPool($obj1, $key1);
			...
			$key2 = LogI18nPeer::getPrimaryKeyHashFromRow($row, $startcol);
			if ($key2 !== null) {
				$obj2 = LogI18nPeer::getInstanceFromPool($key2);
				if (!$obj2) {
					$cls = LogI18nPeer::getOMClass(false);
					$obj2 = new $cls();
					$obj2->hydrate($row, $startcol);
					LogI18nPeer::addInstanceToPool($obj2, $key2);
				} // if obj2 already loaded
	
	      $obj1->setLogI18nForCulture($obj2, $culture);
			} // if joined row was not null
