...
abstract class BaseCommentPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'FileId', 'UserId', 'Title', 'Content', 'CreatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'fileId', 'userId', 'title', 'content', 'createdAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::FILE_ID, self::USER_ID, self::TITLE, self::CONTENT, self::CREATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'file_id', 'user_id', 'title', 'content', 'created_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'FileId' => 1, 'UserId' => 2, 'Title' => 3, 'Content' => 4, 'CreatedAt' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'fileId' => 1, 'userId' => 2, 'title' => 3, 'content' => 4, 'createdAt' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::FILE_ID => 1, self::USER_ID => 2, self::TITLE => 3, self::CONTENT => 4, self::CREATED_AT => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'file_id' => 1, 'user_id' => 2, 'title' => 3, 'content' => 4, 'created_at' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CommentPeer::TITLE);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Comment) to the collection in $obj2 (File)
				$obj2->addComment($obj1);
