...
abstract class BaseUrl extends BaseObject  implements Persistent {
	...
	public function setType($v)
	{
		...
		if ($this->type !== $v) {
			$this->type = $v;
			$this->modifiedColumns[] = UrlPeer::TYPE;
		}
	...
	public function setPath($v)
	{
		...
		if ($this->path !== $v) {
			$this->path = $v;
			$this->modifiedColumns[] = UrlPeer::PATH;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = UrlPeer::NUM_COLUMNS - UrlPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(UrlPeer::CREATED_AT))
				{
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(UrlPeer::TYPE)) $criteria->add(UrlPeer::TYPE, $this->type);
		if ($this->isColumnModified(UrlPeer::PATH)) $criteria->add(UrlPeer::PATH, $this->path);
