...
abstract class BaseTag extends BaseObject  implements Persistent {
	...
	/**
	 * @var        array FileTag[] Collection to store aggregation of FileTag objects.
	 */
	protected $collFileTags;

	/**
	 * @var        Criteria The criteria used to select the current contents of collFileTags.
	 */
	private $lastFileTagCriteria = null;
	...
	public function setCustomerId($v)
	{
		...
		if ($this->customer_id !== $v) {
			$this->customer_id = $v;
			$this->modifiedColumns[] = TagPeer::CUSTOMER_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 5; // 5 = TagPeer::NUM_COLUMNS - TagPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		if ($deep) {  // also de-associate any related objects?
			...
			$this->aCustomer = null;
			$this->collFileTags = null;
			$this->lastFileTagCriteria = null;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->collFileTags !== null) {
				foreach ($this->collFileTags as $referrerFK) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TagPeer::CUSTOMER_ID)) $criteria->add(TagPeer::CUSTOMER_ID, $this->customer_id);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		if ($deepCopy) {
			...
			foreach ($this->getFileTags() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addFileTag($relObj->copy($deepCopy));
				}
			}
	...
	/**
	 * Clears out the collFileTags collection (array).
	 *
	...
	{
		$this->collFileTags = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collFileTags collection (array).
	 *
	 * By default this just sets the collFileTags collection to an empty array (like clearcollFileTags());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initFileTags()
	{
		$this->collFileTags = array();
	}

	/**
	 * Gets an array of FileTag objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Tag has previously been saved, it will retrieve
	 * related FileTags from storage. If this Tag is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 * @return     array FileTag[]
	 * @throws     PropelException
	 */
	public function getFileTags($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(TagPeer::DATABASE_NAME);
		}
		...
		if ($this->collFileTags === null) {
			if ($this->isNew()) {
			   $this->collFileTags = array();
				...
				$criteria->add(FileTagPeer::TAG_ID, $this->id);

				FileTagPeer::addSelectColumns($criteria);
				$this->collFileTags = FileTagPeer::doSelect($criteria, $con);
			}
		} else {
			...
			if (!$this->isNew()) {
				...
				FileTagPeer::addSelectColumns($criteria);
				if (!isset($this->lastFileTagCriteria) || !$this->lastFileTagCriteria->equals($criteria)) {
					$this->collFileTags = FileTagPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastFileTagCriteria = $criteria;
		return $this->collFileTags;
	}

	/**
	 * Returns the number of related FileTag objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related FileTag objects.
	 * @throws     PropelException
	 */
	public function countFileTags(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(TagPeer::DATABASE_NAME);
		} else {
		...
		if ($this->collFileTags === null) {
			if ($this->isNew()) {
				...
				$count = FileTagPeer::doCount($criteria, false, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
	...
	/**
	 * Method called to associate a FileTag object to this object
	 * through the FileTag foreign key attribute.
	 *
	 * @param      FileTag $l FileTag
	 * @return     void
	 * @throws     PropelException
	 */
	public function addFileTag(FileTag $l)
	{
		if ($this->collFileTags === null) {
			$this->initFileTags();
		}
		if (!in_array($l, $this->collFileTags, true)) { // only add it if the **same** object is not already associated
			array_push($this->collFileTags, $l);
			$l->setTag($this);
		}
	}
	...
	{
		if ($deep) {
			if ($this->collFileTags) {
				foreach ((array) $this->collFileTags as $o) {
