...
/**
 * Base class that represents a row from the 'usage_constraint' table.
 *
 * 
 *
 ...
 */
abstract class BaseUsageConstraint extends BaseObject  implements Persistent {
	...
	/**
	 * @var        array UsageConstraintI18n[] Collection to store aggregation of UsageConstraintI18n objects.
	 */
	protected $collUsageConstraintI18ns;

	/**
	 * @var        Criteria The criteria used to select the current contents of collUsageConstraintI18ns.
	 */
	private $lastUsageConstraintI18nCriteria = null;
	...
	const PEER = 'UsageConstraintPeer';
	 ...
	 * @return     UsageConstraint The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = UsageConstraintPeer::ID;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = UsageConstraintPeer::CREATED_AT;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = UsageConstraintPeer::NUM_COLUMNS - UsageConstraintPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating UsageConstraint object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = UsageConstraintPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
		...
		if ($deep) {  // also de-associate any related objects?
			...
			$this->collUsageConstraintI18ns = null;
			$this->lastUsageConstraintI18nCriteria = null;
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseUsageConstraint:delete:pre') as $callable)
			{
			...
			if ($ret) {
				UsageConstraintPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseUsageConstraint:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseUsageConstraint:save:pre') as $callable)
			{
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(UsageConstraintPeer::CREATED_AT))
				{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseUsageConstraint:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				UsageConstraintPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = UsageConstraintPeer::doInsert($this, $con);
					...
					$affectedRows += UsageConstraintPeer::doUpdate($this, $con);
				}
			...
			if ($this->collUsageConstraintI18ns !== null) {
				foreach ($this->collUsageConstraintI18ns as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = UsageConstraintPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = UsageConstraintPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = UsageConstraintPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(UsageConstraintPeer::ID)) $criteria->add(UsageConstraintPeer::ID, $this->id);
		if ($this->isColumnModified(UsageConstraintPeer::CREATED_AT)) $criteria->add(UsageConstraintPeer::CREATED_AT, $this->created_at);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(UsageConstraintPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of UsageConstraint (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		if ($deepCopy) {
			...
			foreach ($this->getUsageConstraintI18ns() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addUsageConstraintI18n($relObj->copy($deepCopy));
				}
			}
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     UsageConstraint Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     UsageConstraintPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new UsageConstraintPeer();
		}
		return self::$peer;
	}
	 ...
	 * Otherwise if this UsageConstraint has previously been saved, it will retrieve
	 * related Files from storage. If this UsageConstraint is new, it will return
		...
		if ($this->collFiles === null) {
			if ($this->isNew()) {
			   $this->collFiles = array();
				...
				$criteria->add(FilePeer::USAGE_CONSTRAINT_ID, $this->id);
	 ...
	 * Otherwise if this UsageConstraint is new, it will return
	 * an empty collection; or if this UsageConstraint has previously
	 * been saved, it will retrieve related Files from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in UsageConstraint.
	 */
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this UsageConstraint has previously been saved, it will retrieve
	 * related Folders from storage. If this UsageConstraint is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collFolders === null) {
			if ($this->isNew()) {
			   $this->collFolders = array();
				...
				$criteria->add(FolderPeer::USAGE_CONSTRAINT_ID, $this->id);
	...
	/**
	 * Clears out the collUsageConstraintI18ns collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 * @return     void
	 * @see        addUsageConstraintI18ns()
	 */
	public function clearUsageConstraintI18ns()
	{
		$this->collUsageConstraintI18ns = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collUsageConstraintI18ns collection (array).
	 *
	 * By default this just sets the collUsageConstraintI18ns collection to an empty array (like clearcollUsageConstraintI18ns());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initUsageConstraintI18ns()
	{
		$this->collUsageConstraintI18ns = array();
	}

	/**
	 * Gets an array of UsageConstraintI18n objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this UsageConstraint has previously been saved, it will retrieve
	 * related UsageConstraintI18ns from storage. If this UsageConstraint is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 * @return     array UsageConstraintI18n[]
	 * @throws     PropelException
	 */
	public function getUsageConstraintI18ns($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(UsageConstraintPeer::DATABASE_NAME);
		}
		...
		if ($this->collUsageConstraintI18ns === null) {
			if ($this->isNew()) {
			   $this->collUsageConstraintI18ns = array();
				...
				$criteria->add(UsageConstraintI18nPeer::ID, $this->id);

				UsageConstraintI18nPeer::addSelectColumns($criteria);
				$this->collUsageConstraintI18ns = UsageConstraintI18nPeer::doSelect($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				UsageConstraintI18nPeer::addSelectColumns($criteria);
				if (!isset($this->lastUsageConstraintI18nCriteria) || !$this->lastUsageConstraintI18nCriteria->equals($criteria)) {
					$this->collUsageConstraintI18ns = UsageConstraintI18nPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastUsageConstraintI18nCriteria = $criteria;
		return $this->collUsageConstraintI18ns;
	}

	/**
	 * Returns the number of related UsageConstraintI18n objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related UsageConstraintI18n objects.
	 * @throws     PropelException
	 */
	public function countUsageConstraintI18ns(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(UsageConstraintPeer::DATABASE_NAME);
		} else {
		...
		if ($this->collUsageConstraintI18ns === null) {
			if ($this->isNew()) {
				...
				$count = UsageConstraintI18nPeer::doCount($criteria, false, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				if (!isset($this->lastUsageConstraintI18nCriteria) || !$this->lastUsageConstraintI18nCriteria->equals($criteria)) {
					...
					$count = count($this->collUsageConstraintI18ns);
				}
			} else {
				$count = count($this->collUsageConstraintI18ns);
			}
	...
	/**
	 * Method called to associate a UsageConstraintI18n object to this object
	 * through the UsageConstraintI18n foreign key attribute.
	 *
	 * @param      UsageConstraintI18n $l UsageConstraintI18n
	 * @return     void
	 * @throws     PropelException
	 */
	public function addUsageConstraintI18n(UsageConstraintI18n $l)
	{
		if ($this->collUsageConstraintI18ns === null) {
			$this->initUsageConstraintI18ns();
		}
		if (!in_array($l, $this->collUsageConstraintI18ns, true)) { // only add it if the **same** object is not already associated
			array_push($this->collUsageConstraintI18ns, $l);
			$l->setUsageConstraint($this);
		}
	}
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this UsageConstraint has previously been saved, it will retrieve
	 * related Presets from storage. If this UsageConstraint is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collPresets === null) {
			if ($this->isNew()) {
			   $this->collPresets = array();
				...
				$criteria->add(PresetPeer::USAGE_CONSTRAINT_ID, $this->id);
	...
	public function clearAllReferences($deep = false)
	{
		if ($deep) {
			...
			if ($this->collUsageConstraintI18ns) {
				foreach ((array) $this->collUsageConstraintI18ns as $o) {
					$o->clearAllReferences($deep);
				}
			}
			if ($this->collPresets) {
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseUsageConstraint:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseUsageConstraint::%s', $method));
	  }
	...
	/**
	 * Returns the "title" value from the current {@link UsageConstraintI18n}.
	 */
	public function getTitle($culture = null)
	{
	  return $this->getCurrentUsageConstraintI18n($culture)->getTitle();
	}
	
	/**
	 * Sets the "title" value of the current {@link UsageConstraintI18n}.
	 *
	 * @return UsageConstraint
	 */
	public function setTitle($value, $culture = null)
	{
	  $this->getCurrentUsageConstraintI18n($culture)->setTitle($value);
	  return $this;
	}
	 ...
	 */
	public function getCurrentUsageConstraintI18n($culture = null)
	{
	  if (null === $culture)
	  {
	  ...
	  {
	    $object = $this->isNew() ? null : UsageConstraintI18nPeer::retrieveByPK($this->getPrimaryKey(), $culture);
	    if ($object)
	    {
	      $this->setUsageConstraintI18nForCulture($object, $culture);
	    }
	    else
	    {
	      $this->setUsageConstraintI18nForCulture(new UsageConstraintI18n(), $culture);
	 ...
	 */
	public function setUsageConstraintI18nForCulture(UsageConstraintI18n $object, $culture)
	{
	  $this->current_i18n[$culture] = $object;
	  $this->addUsageConstraintI18n($object);
	}
