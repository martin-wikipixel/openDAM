...
abstract class BaseRating extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the nb_rate field.
	 * @var        int
	 */
	protected $nb_rate;

	/**
	 * The value for the total_rate field.
	 * @var        int
	 */
	protected $total_rate;

	/**
	 * The value for the user_ids field.
	 * @var        string
	 */
	protected $user_ids;
	...
	/**
	 * Get the [total_rate] column value.
	 * 
	 * @return     int
	 */
	...
	public function setFileId($v)
	{
		...
		if ($this->file_id !== $v) {
			$this->file_id = $v;
			$this->modifiedColumns[] = RatingPeer::FILE_ID;
		}
	...
	/**
	 * Set the value of [nb_rate] column.
	 * 
	 * @param      int $v new value
	 * @return     Rating The current object (for fluent API support)
	 */
	public function setNbRate($v)
	{
		...
		if ($this->nb_rate !== $v) {
			$this->nb_rate = $v;
			$this->modifiedColumns[] = RatingPeer::NB_RATE;
		}
	...
	/**
	 * Set the value of [total_rate] column.
	 * 
	 * @param      int $v new value
	 * @return     Rating The current object (for fluent API support)
	 */
	public function setTotalRate($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->total_rate !== $v) {
			$this->total_rate = $v;
			$this->modifiedColumns[] = RatingPeer::TOTAL_RATE;
		}
	...
	/**
	 * Set the value of [user_ids] column.
	 * 
	...
	public function setUserIds($v)
	{
		...
		if ($this->user_ids !== $v) {
			$this->user_ids = $v;
			$this->modifiedColumns[] = RatingPeer::USER_IDS;
		}
	...
	public function setUpdatedAt($v)
	{
		...
		if ( $this->updated_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = RatingPeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->nb_rate = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			$this->total_rate = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			$this->user_ids = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			...
			return $startcol + 7; // 7 = RatingPeer::NUM_COLUMNS - RatingPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($this->isModified() && !$this->isColumnModified(RatingPeer::UPDATED_AT))
			{
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(RatingPeer::CREATED_AT))
				{
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[2] => $this->getNbRate(),
			$keys[3] => $this->getTotalRate(),
			$keys[4] => $this->getUserIds(),
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 2:
				...
				break;
			case 3:
				$this->setTotalRate($value);
				break;
			case 4:
				$this->setUserIds($value);
				break;
			case 5:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setNbRate($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setTotalRate($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setUserIds($arr[$keys[4]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(RatingPeer::FILE_ID)) $criteria->add(RatingPeer::FILE_ID, $this->file_id);
		if ($this->isColumnModified(RatingPeer::NB_RATE)) $criteria->add(RatingPeer::NB_RATE, $this->nb_rate);
		if ($this->isColumnModified(RatingPeer::TOTAL_RATE)) $criteria->add(RatingPeer::TOTAL_RATE, $this->total_rate);
		if ($this->isColumnModified(RatingPeer::USER_IDS)) $criteria->add(RatingPeer::USER_IDS, $this->user_ids);
		if ($this->isColumnModified(RatingPeer::CREATED_AT)) $criteria->add(RatingPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(RatingPeer::UPDATED_AT)) $criteria->add(RatingPeer::UPDATED_AT, $this->updated_at);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setTotalRate($this->total_rate);

		$copyObj->setUserIds($this->user_ids);
