<?php include_partial("file/navigationManageSingle", array("selected"=>"copy", "folder"=>$folder, "file"=>$file));?>

<div id="searchResults-popup">
	<div class="inner">
		<?php echo form_tag('file/copy', array('name'=>'file_copy_form', 'id'=>'file_copy_form'))?>
...
<div class="right">
	...
	<a href="#" onClick="jQuery('#file_copy_form').submit();"  class="button btnBS"><span><?php echo __("COPY")?></span></a> 
</div>
	</div>
</div>
